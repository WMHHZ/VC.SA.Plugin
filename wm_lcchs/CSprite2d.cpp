...
{
	fpDelete = AddressSelectorLC::SelectAddress<0x51EA00, 0x51EBC0>();
	fpSetVertices = AddressSelectorLC::SelectAddress<0x51F720, 0x51F8E0>();
	fpSetTexture = AddressSelectorLC::SelectAddress<0x51EA70, 0x51EC30>();
}
