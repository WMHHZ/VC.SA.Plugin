...
void WMVC::PatchGame()
{
	unsigned __int8 *FEO_LAN_Entry = addr_sel::vc::select_address<unsigned __int8>({0x6DA386, 0x0, 0x6D9356});
	...
	injector::WriteMemory(addr_sel::vc::select_address<float>({0x68FD58, 0x0, 0x68ED60}), 999.0f);

	unsigned __int8 *SpaceAddInstr = addr_sel::vc::select_address<unsigned __int8>({0x6161BB, 0x0, 0x615DDB});
